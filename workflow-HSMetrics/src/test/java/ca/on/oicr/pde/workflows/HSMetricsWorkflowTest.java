 ...
 * @author prath
 */
public class HSMetricsWorkflowTest {

    public HSMetricsWorkflowTest() {
    }
    ...
    public void validateRegressionTestDefinition() throws IllegalAccessException, InstantiationException, IOException, Exception {
        ...
        for (TestDefinition.Test t : td.getTests()) {
            DryRun d = new DryRun(System.getProperty("bundleDirectory"), t.getParameters(), HSMetricsWorkflow.class);
